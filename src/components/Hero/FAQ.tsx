...
const FAQ = () => {
        ...
        return (
          <motion.div
            ...
            className={`relative border-b-2 ${
              activeIndex === actualIndex ? 'border-sky-500' : 'border-sky-100'
          ...
          >
            ...
            >
              ...
              <ChevronRight
                className={`h-6 w-6 flex-shrink-0 transform text-sky-400 transition-transform duration-300 group-hover:text-sky-600 sm:h-7 sm:w-7 ${
                  activeIndex === actualIndex ? 'rotate-90' : ''
                } group-hover:translate-x-1`}
              />
            </button>
            <div
              className={`absolute bottom-0 left-0 h-0.5 origin-left scale-x-0 transform bg-sky-500 transition-all duration-500 group-hover:scale-x-100 ${
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-white font-sans">
      ...
      <div className="absolute top-16 right-8 h-[200px] w-[200px] rounded-full bg-gradient-to-br from-sky-600 to-sky-800 opacity-10 blur-3xl sm:top-32 sm:right-32 sm:h-[300px] sm:w-[300px] lg:h-[500px] lg:w-[500px]"></div>
      <div className="absolute bottom-16 left-8 h-[200px] w-[200px] rounded-full bg-gradient-to-br from-sky-600 to-sky-800 opacity-10 blur-3xl sm:bottom-32 sm:left-32 sm:h-[300px] sm:w-[300px] lg:h-[500px] lg:w-[500px]"></div>
      ...
      >
        <div className="rounded-2xl p-6 text-black sm:p-8">
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <button className="w-full rounded-full border border-sky-200 bg-white px-6 py-3 font-semibold text-sky-600 transition-colors hover:bg-gray-100 sm:w-auto sm:px-8">
              Get Started Today
            </button>
            <GlowButton
