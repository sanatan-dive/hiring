    ...
    >
        ...
        {uploadedFile ? (
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.9 }}
              onClick={removeFile}
              className="absolute top-2 right-2 rounded-full bg-gray-200 p-1 text-gray-600 hover:bg-red-200 hover:text-red-600"
            >
              <X className="h-4 w-4" />
            </motion.button>
          </motion.div>
          ...
          >
            ...
            <p className="mt-2 text-sm text-gray-600">
              {isDragActive
                ? 'Drop the files here ...'
                : "Drag 'n' drop your resume here, or click to select"}
            </p>
      ...
      <AnimatePresence>
        {isHovering && !uploadedFile && (
          ...
          >
            <div className="flex items-center space-x-2 rounded-full bg-sky-500 px-3 py-1 text-xs text-white">
